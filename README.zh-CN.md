<p align="center">
  <a href="README.zh-CN.md">簡體中文</a> · <a href="README.zh-TW.md">繁體中文</a> · <a href="README.md">English</a> · <a href="README.cat.md">喵喵英語</a>
</p>
...
### 2. Java 检测（Java Detection） (ﾐ´ω｀ﾐ)
...
# 输出: ui/build/libs/pmcl-1.3.0c-all.jar
# 运行: java -jar ui/build/libs/pmcl-1.3.0c-all.jar
```
