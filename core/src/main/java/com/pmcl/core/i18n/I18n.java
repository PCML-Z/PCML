...
public final class I18n {
    ...
    private static void initZh() {
        ...
        ZH.put("nav.music", "音乐");
        ZH.put("nav.group.core", "核心");
        ZH.put("nav.group.community", "社区");
        ZH.put("nav.group.entertainment", "娱乐");
        ZH.put("nav.group.tools", "工具");
        ZH.put("nav.customize", "自定义导航");
        ZH.put("nav.customize.hint", "勾选要显示的导航项，核心区常驻不可隐藏");
        ZH.put("nav.customize.reset", "恢复默认");
    ...
    private static void initEn() {
        ...
        EN.put("nav.group.core", "Core");
        EN.put("nav.group.community", "Community");
        EN.put("nav.group.entertainment", "Entertainment");
        EN.put("nav.group.tools", "Tools");
        EN.put("nav.customize", "Customize Navigation");
        EN.put("nav.customize.hint", "Check items to show. Core group is always visible.");
        EN.put("nav.customize.reset", "Reset to Default");
    ...
    private static void initJa() {
        ...
        JA.put("nav.music", "音楽");
        JA.put("nav.group.core", "コア");
        JA.put("nav.group.community", "コミュニティ");
        JA.put("nav.group.entertainment", "エンタメ");
        JA.put("nav.group.tools", "ツール");
        JA.put("nav.customize", "ナビゲーション設定");
        JA.put("nav.customize.hint", "表示する項目にチェック。コアは常に表示");
        JA.put("nav.customize.reset", "デフォルトに戻す");
