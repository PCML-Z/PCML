...
public final class I18n {
    ...
    private static void initZh() {
        ...
        ZH.put("mods.search_web", "网上搜");
        ZH.put("mods.search_mcmod", "MC百科");
        ZH.put("mods.search_mc_china", "MC中国站");
        ZH.put("mods.search_mcbbs", "MCBBS");
        ...
        ZH.put("instance.change_icon", "更换图标");
        ZH.put("instance.select_icon", "选择图标图片");
        ...
        ZH.put("accounts.offline.buy_hint", "给童年补一张票，买一份正版我的世界");
        ZH.put("accounts.offline.buy_link", "官网购买");
        ZH.put("accounts.offline.buy_url", "https://www.minecraft.net/zh-hans/store/minecraft-java-bedrock-edition-pc");
        ...
        ZH.put("about.description", "喵～ 这是 PMCL，一只会帮你开 Minecraft 的猫猫启动器 (=^･ω･^=)ﾉ");
        ZH.put("about.features", "本猫会这些 ฅ^•ﻌ•^ฅ");
        ZH.put("about.features.core", "开游戏 (=^･ω･^=)");
        ZH.put("about.features.content", "找资源 ฅ^•ﻌ•^ฅ");
        ZH.put("about.features.tools", "修修补补 (=；ェ；=)");
        ZH.put("about.features.extensions", "更多好玩的 (=｀ω´=)");
        ZH.put("about.feat.account", "微软账号直接登");
        ZH.put("about.feat.versions", "版本想装就装");
        ZH.put("about.feat.modloaders", "Forge / Fabric / Quilt / NeoForge");
        ZH.put("about.feat.presets", "启动参数存成套餐");
        ZH.put("about.feat.market", "去 Modrinth / CurseForge 逛街");
        ZH.put("about.feat.contents", "模组、整合包、光影、资源包、数据包");
        ZH.put("about.feat.config", "配置文件直接改");
        ZH.put("about.feat.saves", "世界存档和截图");
        ZH.put("about.feat.nbt", "NBT 也能翻");
        ZH.put("about.feat.crash", "崩了帮你瞅瞅");
        ZH.put("about.feat.java", "Java 版本自己挑");
        ZH.put("about.feat.multiplayer", "陶瓦联机，找朋友开黑");
        ZH.put("about.feat.friends", "好友和聊天");
        ZH.put("about.feat.video", "还能视频通话");
        ZH.put("about.feat.music", "B站 / A站 / 直链听音乐");
        ZH.put("about.feat.plugins", "插件 (.ppk) 随便加");
        ZH.put("about.feat.news", "Minecraft.net 新鲜事");
        ZH.put("about.feat.terminal", "自带终端，爱敲命令的猫用");
        ZH.put("about.tech_stack", "技术栈");
        ZH.put("about.open_source", "引用开源项目");
        ZH.put("about.license.conflict_banner", "本软件用的是自定义非商业许可证，不是 GPL / MIT / Apache。GPL、LGPL 不允许再加「不得商用」这类限制。下面按条标了可能的冲突。许可证第 8.4 条写「以第三方许可证为准、只限该组件」，这挡不住 GPL 对组合作品的要求。");
        ZH.put("about.license.conflict_label", "可能冲突");
        ZH.put("about.license.notice_label", "注意");
        ZH.put("about.license.conflict.java", "GPL-2.0 + Classpath Exception。当独立模块链接时一般可与其他许可证共存。若把 JDK 源码并进不可分割的单一作品、或改完后不再保持模块边界，Classpath Exception 可能失效，从而与 Apache 2.0 依赖及本许可证冲突。Apache 2.0 与 GPL-2.0 本身不兼容，全靠 Classpath Exception 隔离。");
        ZH.put("about.license.conflict.javafx", "GPL-2.0 + Classpath Exception。独立模块使用通常可共存。打进 fat JAR、模块边界不清时，存在与 Apache 2.0 组件及本许可证冲突的风险。");
        ZH.put("about.license.conflict.ffmpeg", "经 JavaCV/ByteDeco 预编译包引入，常见构建带 --enable-gpl。若实际链接的是 GPL 版 FFmpeg，组合作品须按 GPL 兼容条款分发；本许可证的非商业限制是 GPL 不允许的额外限制。只有分发可替换的 LGPL 构建并履行再链接义务时，才可能避开。");
        ZH.put("about.license.conflict.javacv", "常见授权为 GPL-2.0（或带 Classpath Exception）。若无 Classpath Exception，或与 GPL 版 FFmpeg 绑在一起，可能迫使组合作品遵循 GPL，与本许可证的非商业条款冲突。");
        ZH.put("about.license.conflict.easytier", "LGPL-3.0（不是 Apache 2.0）。LGPL-3 要求保留对该库的替换/再链接权利，且不得用额外条款限制对该库的 GPL/LGPL 权利。EasyTier 虽以独立进程运行，若把其二进制算进「本软件」并套用非商业限制，即构成冲突。须单独保留 LGPL-3.0、提供源码或书面要约，并允许用户替换该二进制。");
        ZH.put("about.license.conflict.hmcl", "GPL-3.0。若嵌入分发构成组合作品，GPL-3 禁止再加非商业等限制；第 8.4 条不能对抗 GPL 对整份组合作品的要求。仅当 HMCL 作为完全独立程序单纯聚合分发时，才可能不触发。");
        ...
        ZH.put("about.license.conflict_tab", "许可证冲突");
        ...
        ZH.put("settings.theme.color", "配色");
        ZH.put("settings.theme.background", "背景");
        ZH.put("settings.theme.effects", "界面效果");
        ZH.put("settings.theme.scale", "缩放");
        ZH.put("settings.follow_system", "跟随系统");
        ZH.put("settings.follow_system_desc", "深浅色跟随系统外观，系统切换时实时生效");
        ZH.put("settings.theme_source_hint", "配色优先级：插件主题 > 莫奈取色 / 自定义强调色 > 色彩预设");
        ...
        ZH.put("settings.http_proxy", "使用代理");
        ZH.put("settings.proxy_host", "主机");
        ZH.put("settings.proxy_port", "端口");
        ZH.put("settings.proxy_auth", "代理认证");
        ZH.put("settings.proxy_type", "代理类型");
        ZH.put("settings.proxy_type_http", "HTTP");
        ZH.put("settings.proxy_type_socks5", "SOCKS5");
        ZH.put("settings.proxy_socks_hint", "SOCKS5 适用于 Clash / V2Ray 等本地端口。用户名密码认证仅支持 HTTP 代理。本机回环不走代理。");
        ZH.put("settings.proxy_test", "测试连接");
        ZH.put("settings.proxy_testing", "正在测试…");
        ZH.put("settings.proxy_test_ok", "连通成功（{0}）");
        ZH.put("settings.proxy_test_fail", "连通失败：{0}");
        ...
        ZH.put("settings.hect_mi_decode", "解码");
        ZH.put("settings.hect_mi_decode_title", "HECT-MI 解码器");
        ZH.put("settings.hect_mi_decode_failed", "解码失败，无法收集环境因子");
        ZH.put("settings.hect_mi_format_valid", "格式合法");
        ZH.put("settings.hect_mi_format_invalid", "格式不合法");
        ...
        // ===== 迁移 =====
        ZH.put("migration.title", "导入");
        ZH.put("migration.from", "从 {0} 导入");
        ZH.put("migration.size", "{0}");
        ZH.put("migration.done", "已导入");
        ZH.put("migration.processing", "导入中…");
        ZH.put("migration.heading", "从别的启动器拎过来 (=^･ω･^=)");
        ZH.put("migration.no_source", "没翻到别的启动器 (=；ェ；=)");
        ZH.put("migration.skip", "先进去");
        ...
        ZH.put("crash.popup.title", "游戏崩溃了");
        ZH.put("crash.popup.live", "崩溃报告输出中");
        ZH.put("crash.popup.info", "版本 {0} · 退出码 {1}");
        ZH.put("crash.popup.info_live", "版本 {0} · 崩溃报告输出中");
        ZH.put("crash.popup.pack", "生成支持包");
        ZH.put("crash.popup.help", "联机解决问题");
        ZH.put("crash.popup.relaunch", "重启游戏");
        ZH.put("crash.popup.pack_ok", "支持包已保存：{0}");
        ZH.put("crash.popup.pack_fail", "生成支持包失败：{0}");
        ZH.put("crash.popup.pack_busy", "正在打包…");
        ZH.put("crash.popup.close", "关闭");
        ZH.put("crash.popup.report", "崩溃报告");
        ZH.put("crash.pack.save", "保存支持包");
        ...
        ZH.put("settings.theme_preset.ember", "赤焰红");
        ZH.put("settings.theme_preset.teal", "青绿");
        ZH.put("settings.theme_preset.sand", "沙金");
        ...
        ZH.put("market.use_current_instance", "当前实例");
        ZH.put("market.detail_filter_title", "按游戏版本 / 加载器筛选");
        ZH.put("market.detail_filter_hint", "仅显示兼容的模组文件");
        ZH.put("market.compatible_files", "兼容文件（{0}/{1}）");
        ZH.put("market.filter_compatible", "仅显示兼容");
        ZH.put("market.show_all_versions", "显示全部版本");
        ZH.put("market.no_compatible_files", "没有兼容当前版本/加载器的文件，可切换显示全部版本");
        ...
        ZH.put("status.instance_icon_set", "实例图标已更新");
        ZH.put("status.instance_icon_cleared", "实例图标已清除");
        ZH.put("status.instance_icon_set_failed", "设置图标失败: {0}");
    ...
    private static void initEn() {
        ...
        EN.put("mods.search_web", "Search online");
        EN.put("mods.search_mcmod", "MCMod");
        EN.put("mods.search_mc_china", "Minecraft.net");
        EN.put("mods.search_mcbbs", "MCBBS");
        ...
        EN.put("instance.change_icon", "Change Icon");
        EN.put("instance.select_icon", "Select Icon Image");
        ...
        EN.put("accounts.offline.buy_hint", "Buy a real copy of Minecraft — a ticket for the kid you were");
        EN.put("accounts.offline.buy_link", "Official store");
        EN.put("accounts.offline.buy_url", "https://www.minecraft.net/en-us/store/minecraft-java-bedrock-edition-pc");
        ...
        EN.put("about.description", "meow~ PMCL is a cat that launches Minecraft for you (=^･ω･^=)ﾉ");
        EN.put("about.features", "this cat can ฅ^•ﻌ•^ฅ");
        EN.put("about.features.core", "play (=^･ω･^=)");
        EN.put("about.features.content", "loot ฅ^•ﻌ•^ฅ");
        EN.put("about.features.tools", "fix-it (=；ェ；=)");
        EN.put("about.features.extensions", "extra fun (=｀ω´=)");
        EN.put("about.feat.account", "sign in with Microsoft");
        EN.put("about.feat.versions", "install whatever version you want");
        EN.put("about.feat.modloaders", "Forge / Fabric / Quilt / NeoForge");
        EN.put("about.feat.presets", "save launch args as presets");
        EN.put("about.feat.market", "browse Modrinth / CurseForge");
        EN.put("about.feat.contents", "mods, modpacks, shaders, resource packs, datapacks");
        EN.put("about.feat.config", "edit configs in place");
        EN.put("about.feat.saves", "worlds and screenshots");
        EN.put("about.feat.nbt", "poke around in NBT");
        EN.put("about.feat.crash", "crashed? this cat will look");
        EN.put("about.feat.java", "picks the right Java");
        EN.put("about.feat.multiplayer", "Terracotta LAN with friends");
        EN.put("about.feat.friends", "friends and chat");
        EN.put("about.feat.video", "video calls too");
        EN.put("about.feat.music", "BiliBili / AcFun / direct links");
        EN.put("about.feat.plugins", "drop in .ppk plugins");
        EN.put("about.feat.news", "fresh from Minecraft.net");
        EN.put("about.feat.terminal", "a terminal for command-line cats");
        EN.put("about.tech_stack", "Tech Stack");
        EN.put("about.open_source", "Open Source");
        EN.put("about.license.conflict_banner", "PMCL uses a custom non-commercial license, not GPL, MIT, or Apache. GPL/LGPL forbid extra restrictions such as “non-commercial only”. Possible conflicts are marked below. License §8.4 says the third-party license wins within that component — that does not waive GPL obligations for a combined work.");
        EN.put("about.license.conflict_label", "Possible conflict");
        EN.put("about.license.notice_label", "Note");
        EN.put("about.license.conflict.java", "GPL-2.0 + Classpath Exception. Linking as a separate module is usually fine. If JDK sources are merged into one inseparable work, or module boundaries are dropped after modification, the Classpath Exception may not apply — conflicting with Apache 2.0 dependencies and this license. Apache 2.0 is incompatible with GPL-2.0; isolation depends on the Classpath Exception.");
        EN.put("about.license.conflict.javafx", "GPL-2.0 + Classpath Exception. Fine as a separate module. Bundling into a fat JAR that blurs module boundaries risks conflict with Apache 2.0 components and this license.");
        EN.put("about.license.conflict.ffmpeg", "Pulled in via JavaCV/ByteDeco prebuilds, which often use --enable-gpl. If the linked FFmpeg is GPL, the combined work must be distributed under GPL-compatible terms; this license’s non-commercial limit is an extra restriction GPL forbids. Avoidable only with a replaceable LGPL build and relinking obligations met.");
        EN.put("about.license.conflict.javacv", "Typically GPL-2.0 (sometimes with Classpath Exception). Without the Exception, or if bound to GPL FFmpeg, the combined work may have to follow GPL, conflicting with this license’s non-commercial terms.");
        EN.put("about.license.conflict.easytier", "LGPL-3.0 (not Apache 2.0). LGPL-3 requires the right to replace/relink the library and forbids extra limits on GPL/LGPL rights in that library. EasyTier runs as a separate process, but treating its binary as part of “this software” under the non-commercial terms is a conflict. Keep LGPL-3.0 on that binary, provide source or a written offer, and allow replacement.");
        EN.put("about.license.conflict.hmcl", "GPL-3.0. If embedding counts as a combined work, GPL-3 forbids extra restrictions such as non-commercial use; §8.4 cannot override GPL for the whole combined work. May not trigger only if HMCL is mere aggregation as a fully separate program.");
        ...
        EN.put("about.license.conflict_tab", "License Conflicts");
        ...
        EN.put("settings.theme.color", "Colors");
        EN.put("settings.theme.background", "Background");
        EN.put("settings.theme.effects", "Effects");
        EN.put("settings.theme.scale", "Scale");
        EN.put("settings.follow_system", "Follow system");
        EN.put("settings.follow_system_desc", "Light and dark follow the system appearance");
        EN.put("settings.theme_source_hint", "Priority: plugin pack > Monet / custom accent > preset");
        ...
        EN.put("settings.http_proxy", "Use proxy");
        EN.put("settings.proxy_host", "Host");
        EN.put("settings.proxy_port", "Port");
        EN.put("settings.proxy_auth", "Proxy auth");
        EN.put("settings.proxy_type", "Proxy type");
        EN.put("settings.proxy_type_http", "HTTP");
        EN.put("settings.proxy_type_socks5", "SOCKS5");
        EN.put("settings.proxy_socks_hint", "SOCKS5 works with Clash / V2Ray local ports. Username/password auth is HTTP-only. Loopback traffic bypasses the proxy.");
        EN.put("settings.proxy_test", "Test connection");
        EN.put("settings.proxy_testing", "Testing…");
        EN.put("settings.proxy_test_ok", "Connected ({0})");
        EN.put("settings.proxy_test_fail", "Connection failed: {0}");
        ...
        EN.put("settings.hect_mi_decode", "Decode");
        EN.put("settings.hect_mi_decode_title", "HECT-MI Decoder");
        EN.put("settings.hect_mi_decode_failed", "Decode failed: unable to collect environment factors");
        EN.put("settings.hect_mi_format_valid", "Format valid");
        EN.put("settings.hect_mi_format_invalid", "Format invalid");
        ...
        EN.put("migration.title", "Import");
        EN.put("migration.from", "Import from {0}");
        EN.put("migration.size", "{0}");
        EN.put("migration.done", "Imported");
        EN.put("migration.processing", "Importing…");
        EN.put("migration.heading", "grab from other launchers (=^･ω･^=)");
        EN.put("migration.no_source", "didn't find any (=；ェ；=)");
        EN.put("migration.skip", "just go in");
        ...
        EN.put("crash.popup.title", "Minecraft crashed");
        EN.put("crash.popup.live", "Writing crash report");
        EN.put("crash.popup.info", "Version {0} · exit {1}");
        EN.put("crash.popup.info_live", "Version {0} · crash report coming in");
        EN.put("crash.popup.pack", "Support pack");
        EN.put("crash.popup.help", "Fix it together");
        EN.put("crash.popup.relaunch", "Relaunch");
        EN.put("crash.popup.pack_ok", "Support pack saved: {0}");
        EN.put("crash.popup.pack_fail", "Could not write support pack: {0}");
        EN.put("crash.popup.pack_busy", "Packing…");
        EN.put("crash.popup.close", "Close");
        EN.put("crash.popup.report", "Crash report");
        EN.put("crash.pack.save", "Save support pack");
        ...
        EN.put("settings.theme_preset.ember", "Ember");
        EN.put("settings.theme_preset.teal", "Teal");
        EN.put("settings.theme_preset.sand", "Sand");
        ...
        EN.put("market.use_current_instance", "Current instance");
        EN.put("market.detail_filter_title", "Filter by game version / loader");
        EN.put("market.detail_filter_hint", "Showing compatible mod files only");
        EN.put("market.compatible_files", "Compatible files ({0}/{1})");
        EN.put("market.filter_compatible", "Compatible only");
        EN.put("market.show_all_versions", "Show all versions");
        EN.put("market.no_compatible_files", "No files match the current version/loader. You can show all versions.");
        ...
        EN.put("status.instance_icon_set", "Instance icon updated");
        EN.put("status.instance_icon_cleared", "Instance icon cleared");
        EN.put("status.instance_icon_set_failed", "Failed to set icon: {0}");
    ...
    private static void initJa() {
        ...
        JA.put("mods.search_web", "ウェブで検索");
        JA.put("mods.search_mcmod", "MC百科");
        JA.put("mods.search_mc_china", "Minecraft.net");
        JA.put("mods.search_mcbbs", "MCBBS");
        ...
        JA.put("instance.change_icon", "アイコン変更");
        JA.put("instance.select_icon", "アイコン画像を選択");
        ...
        JA.put("accounts.offline.buy_hint", "子どもの自分へのチケットとして、正規版 Minecraft を買う");
        JA.put("accounts.offline.buy_link", "公式ストア");
        JA.put("accounts.offline.buy_url", "https://www.minecraft.net/ja-jp/store/minecraft-java-bedrock-edition-pc");
        ...
        JA.put("about.description", "にゃん～ Minecraft を起動してくれる猫ランチャーだよ (=^･ω･^=)ﾉ");
        JA.put("about.features", "この猫ができること ฅ^•ﻌ•^ฅ");
        JA.put("about.features.core", "遊ぶ (=^･ω･^=)");
        JA.put("about.features.content", "探す ฅ^•ﻌ•^ฅ");
        JA.put("about.features.tools", "直す (=；ェ；=)");
        JA.put("about.features.extensions", "もっと遊ぶ (=｀ω´=)");
        JA.put("about.feat.account", "Microsoft ですぐログイン");
        JA.put("about.feat.versions", "入れたいバージョンを入れる");
        JA.put("about.feat.modloaders", "Forge / Fabric / Quilt / NeoForge");
        JA.put("about.feat.presets", "起動設定をセットで保存");
        JA.put("about.feat.market", "Modrinth / CurseForge をぶらぶら");
        JA.put("about.feat.contents", "MOD・統合パック・シェーダー・リソース・データパック");
        JA.put("about.feat.config", "設定ファイルをそのまま編集");
        JA.put("about.feat.saves", "ワールドとスクリーンショット");
        JA.put("about.feat.nbt", "NBT も覗ける");
        JA.put("about.feat.crash", "落ちたらこの猫が見る");
        JA.put("about.feat.java", "Java は自分で選ぶ");
        JA.put("about.feat.multiplayer", "テラコッタで友達と遊ぶ");
        JA.put("about.feat.friends", "フレンドとチャット");
        JA.put("about.feat.video", "ビデオ通話もできる");
        JA.put("about.feat.music", "BiliBili / AcFun / 直リンクで聞く");
        JA.put("about.feat.plugins", ".ppk プラグインをぽいっと");
        JA.put("about.feat.news", "Minecraft.net の新着");
        JA.put("about.feat.terminal", "コマンド好きな猫用ターミナル");
        JA.put("about.tech_stack", "技術スタック");
        JA.put("about.open_source", "引用オープンソース");
        JA.put("about.license.conflict_banner", "本ソフトは独自の非商用ライセンスであり、GPL / MIT / Apache ではない。GPL・LGPL は「非商用のみ」などの追加制限を禁じる。下記は起こり得る衝突。ライセンス第 8.4 条の「第三者ライセンスが当該コンポーネントの範囲で優先」は、結合著作物に対する GPL の要求を打ち消さない。");
        JA.put("about.license.conflict_label", "衝突の可能性");
        JA.put("about.license.notice_label", "注意");
        JA.put("about.license.conflict.java", "GPL-2.0 + Classpath Exception。独立モジュールとしてリンクする分には通常共存できる。JDK ソースを不可分の単一作品に取り込んだり、改変後にモジュール境界を失ったりすると Classpath Exception が効かなくなり、Apache 2.0 依存および本ライセンスと衝突し得る。Apache 2.0 と GPL-2.0 は非互換で、隔離は Classpath Exception に依存する。");
        JA.put("about.license.conflict.javafx", "GPL-2.0 + Classpath Exception。独立モジュールなら通常問題ない。fat JAR にまとめモジュール境界が曖昧になると、Apache 2.0 コンポーネントおよび本ライセンスと衝突するリスクがある。");
        JA.put("about.license.conflict.ffmpeg", "JavaCV/ByteDeco のプレビルド経由。よく --enable-gpl 付き。リンク先が GPL 版 FFmpeg なら結合著作物は GPL 互換条件で配布する必要があり、本ライセンスの非商用制限は GPL が禁じる追加制限。置換可能な LGPL ビルドを配布し再リンク義務を果たす場合に限り回避し得る。");
        JA.put("about.license.conflict.javacv", "多くは GPL-2.0（Classpath Exception 付きの場合あり）。Exception が無い、または GPL 版 FFmpeg と一体だと、結合著作物が GPL に従う必要があり、本ライセンスの非商用条項と衝突し得る。");
        JA.put("about.license.conflict.easytier", "LGPL-3.0（Apache 2.0 ではない）。LGPL-3 は当該ライブラリの置換・再リンクを認め、その GPL/LGPL 権利への追加制限を禁じる。別プロセスでも、バイナリを「本ソフト」に含めて非商用制限を掛ければ衝突。LGPL-3.0 を単独で残し、ソースまたは書面の提供、バイナリ置換を認める必要がある。");
        JA.put("about.license.conflict.hmcl", "GPL-3.0。埋め込み配布が結合著作物なら、GPL-3 は非商用などの追加制限を禁じ、第 8.4 条は結合著作物全体への GPL を覆せない。完全に独立したプログラムとして単なる集約配布の場合に限り、衝突しない可能性がある。");
        ...
        JA.put("about.license.conflict_tab", "ライセンス衝突");
        ...
        JA.put("settings.theme.color", "配色");
        JA.put("settings.theme.background", "背景");
        JA.put("settings.theme.effects", "効果");
        JA.put("settings.theme.scale", "スケール");
        JA.put("settings.follow_system", "システムに合わせる");
        JA.put("settings.follow_system_desc", "ライト/ダークをシステムの外観に追従");
        JA.put("settings.theme_source_hint", "優先度：プラグインテーマ > モネ / カスタムアクセント > プリセット");
        ...
        JA.put("settings.http_proxy", "プロキシを使用");
        JA.put("settings.proxy_host", "ホスト");
        JA.put("settings.proxy_port", "ポート");
        JA.put("settings.proxy_auth", "プロキシ認証");
        JA.put("settings.proxy_type", "プロキシ種類");
        JA.put("settings.proxy_type_http", "HTTP");
        JA.put("settings.proxy_type_socks5", "SOCKS5");
        JA.put("settings.proxy_socks_hint", "SOCKS5 は Clash / V2Ray などのローカルポート向け。ユーザー認証は HTTP プロキシのみ。ループバックはプロキシを経由しません。");
        JA.put("settings.proxy_test", "接続テスト");
        JA.put("settings.proxy_testing", "テスト中…");
        JA.put("settings.proxy_test_ok", "接続成功（{0}）");
        JA.put("settings.proxy_test_fail", "接続失敗：{0}");
        ...
        JA.put("settings.hect_mi_decode", "デコード");
        JA.put("settings.hect_mi_decode_title", "HECT-MI デコーダー");
        JA.put("settings.hect_mi_decode_failed", "デコード失敗：環境因子を収集できません");
        JA.put("settings.hect_mi_format_valid", "フォーマット有効");
        JA.put("settings.hect_mi_format_invalid", "フォーマット無効");
        ...
        JA.put("migration.title", "取り込み");
        JA.put("migration.from", "{0} から取り込む");
        JA.put("migration.size", "{0}");
        JA.put("migration.done", "済み");
        JA.put("migration.processing", "取り込み中…");
        JA.put("migration.heading", "ほかのランチャーから持ってくる (=^･ω･^=)");
        JA.put("migration.no_source", "見つからなかったよ (=；ェ；=)");
        JA.put("migration.skip", "先に入る");
        ...
        JA.put("crash.popup.title", "ゲームがクラッシュしました");
        JA.put("crash.popup.live", "クラッシュレポート出力中");
        JA.put("crash.popup.info", "バージョン {0} · 終了コード {1}");
        JA.put("crash.popup.info_live", "バージョン {0} · レポート出力中");
        JA.put("crash.popup.pack", "サポートパック");
        JA.put("crash.popup.help", "一緒に解決");
        JA.put("crash.popup.relaunch", "再起動");
        JA.put("crash.popup.pack_ok", "サポートパックを保存しました：{0}");
        JA.put("crash.popup.pack_fail", "サポートパックの作成に失敗：{0}");
        JA.put("crash.popup.pack_busy", "作成中…");
        JA.put("crash.popup.close", "閉じる");
        JA.put("crash.popup.report", "クラッシュレポート");
        JA.put("crash.pack.save", "サポートパックを保存");
        ...
        JA.put("settings.theme_preset.ember", "エンバー");
        JA.put("settings.theme_preset.teal", "ティール");
        JA.put("settings.theme_preset.sand", "サンド");
        ...
        JA.put("market.use_current_instance", "現在のインスタンス");
        JA.put("market.detail_filter_title", "ゲームバージョン / ローダーで絞り込み");
        JA.put("market.detail_filter_hint", "互換のあるModファイルのみ表示");
        JA.put("market.compatible_files", "互換ファイル（{0}/{1}）");
        JA.put("market.filter_compatible", "互換のみ表示");
        JA.put("market.show_all_versions", "すべてのバージョンを表示");
        JA.put("market.no_compatible_files", "現在のバージョン/ローダーに互換のファイルがありません。すべて表示に切り替えられます。");
        ...
        JA.put("status.instance_icon_set", "インスタンスアイコンを更新しました");
        JA.put("status.instance_icon_cleared", "インスタンスアイコンをクリアしました");
        JA.put("status.instance_icon_set_failed", "アイコンの設定に失敗: {0}");
